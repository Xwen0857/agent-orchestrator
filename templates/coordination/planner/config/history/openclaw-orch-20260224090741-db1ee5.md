...
version: v2-phase4
updated_at: 2026-02-13T04:34:30Z
...
system_health_script: agent-orchestrator/scripts/system_health_check.sh
config_pointer_file: templates/coordination/planner/config/current.pointer.json
config_history_dir: templates/coordination/planner/config/history
config_snapshot_script: agent-orchestrator/scripts/config_snapshot.sh
config_rollback_script: agent-orchestrator/scripts/config_rollback.sh
